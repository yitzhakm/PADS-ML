...
module type S = sig
  ...
  *)
  ...
  module Extension : BaseType with type t = Generic_common.BTExtension.t * string and type in_state = in_state and type out_state = out_state
...
(** Functions for tuples and records. *)
  module Record : sig
    ...
    **)
    ...
    (**
      process a field of the record lazily
     **)
    ...
    (**
       ...
       returns a lazy state, so that the traversal is delayed
    **)
  ...
  module Datatype : sig
    ...
    **)
    ...
    (**
      ...
      eltState    : state for element, lazily computed
...
sig
  ...
  type ('in_state,'out_state, 'record_p_state, 'datatype_p_state, 
	  ...
	  extension_t : (Generic_common.BTExtension.t * string, 'in_state, 'out_state) base_type;
  ...
  sig 
    val tool : (Tool.in_state,Tool.out_state,Tool.Record.partial_state,Tool.Datatype.partial_state,
