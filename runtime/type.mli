...
(** A compiled pads/ml description. *)
...
module Convert_type (Ty: S) : Old_S with type rep = Ty.rep and type pd_body = Ty.pd_body
module Convert_lazy_type (Ty: S) : Old_Lazy_S with type rep = Ty.rep and type pd_body = Ty.pd_body
